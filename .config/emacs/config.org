...
#+begin_src emacs-lisp
  (use-package general
    ...
    (leader-keys
      ...
      "p p" '(project-switch-project :wk "Projectile Switch Project")
      "p f" '(project-find-file :wk "Projectile Find File in Project")
      "p g" '(project-find-regexp :wk "Projectile Find in project with regexp")) 
...
#+begin_src emacs-lisp
	...
	(which-key-mode 1)
      :config
	(setq which-key-side-windo-location 'bottom
